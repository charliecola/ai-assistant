<template>
  <div class="chat-container">
    ...
    <main class="chat-main" ref="chatContainerRef">
          ...
          <template v-else>
            <div class="assistant-message-container">
              <div class="message-bubble assistant-bubble">
                <div class="message-content" :class="{ 'content-collapsed': message.hasOverflow && !message.isExpanded }">
                  {{ message.content }}
                </div>
                ...
                <div v-if="message.hasOverflow" class="expand-action">
                  <el-link type="primary" :underline="false" @click="toggleExpand(message)">
                    {{ message.isExpanded ? '收起' : '展开' }}<el-icon class="el-icon--right"><DArrowRight /></el-icon>
                  </el-link>
                </div>
      ...
      <!-- 相关政策文件 -->
      <el-card class="policy-files-section">
        <template #header>
...
const demoMessages = ref([
  ...
  {
    content: `好的，我来分析一下用户的问题。用户输入的是"2223"，这看起来像是一串数字，并不是一个有意义的文字或英文单词。首先，我会检查是否有可能是打字错误或者编码问题。

考虑到之前的对话中提到的是关于高层次人才项目和青年企业家培育的政策，可能是用户误输入了正确的关键词。例如，"高层次人才"、"青年企业...因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。因此，我需要礼貌地告知用户，无法根据提供的信息回答问题，并请求用户提供更多细节或重新提问，以便更好地帮助他们。`,
    role: 'assistant',
    showFeedback: true,
    isExpanded: false,
    hasOverflow: true
...
const checkMessageOverflow = () => {
  ...
  messageContents.forEach((content, index) => {
    // 只处理助手消息
    if (demoMessages.value[index] && demoMessages.value[index].role === 'assistant') {
      const scrollHeight = content.scrollHeight
      const clientHeight = content.clientHeight
      demoMessages.value[index].hasOverflow = scrollHeight > 182
    }
  })
}
</script>
...
.assistant-bubble {
  ...
  border-radius: 0 15px 15px 15px; /* 只保留右上角和底部圆角 */
...
:deep(.el-link) {
  text-decoration: none;
  --el-link-font-size: 15px; /* 覆盖Element Plus默认的链接字体大小 */
  font-size: 15px; /* 直接设置字体大小 */
}
...
:deep(.el-button:focus), :deep(.el-button:active) {
